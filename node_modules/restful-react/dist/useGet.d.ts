...
declare type RefetchOptions<TData, TQueryParams> = Partial<Omit<UseGetProps<TData, TQueryParams>, "lazy">>;
...
export declare function useGet<TData = any, TError = any, TQueryParams = {
    [key: string]: any;
}>(path: string, props?: Omit<UseGetProps<TData, TQueryParams>, "path">): UseGetReturn<TData, TError, TQueryParams>;
export declare function useGet<TData = any, TError = any, TQueryParams = {
    [key: string]: any;
}>(props: UseGetProps<TData, TQueryParams>): UseGetReturn<TData, TError, TQueryParams>;
export {};
