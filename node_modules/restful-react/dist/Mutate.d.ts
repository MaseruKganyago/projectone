...
export declare type MutateMethod<TData, TRequestBody> = (data: TRequestBody, mutateRequestOptions?: RequestInit) => Promise<TData>;
/**
...
declare function Mutate<TData = any, TError = any, TQueryParams = {
    [key: string]: any;
}, TRequestBody = any>(props: MutateProps<TData, TError, TQueryParams, TRequestBody>): JSX.Element;
